...
urlpatterns = [
    ...
    path('faq1/', faq_view, name='faq_page'),
    path('help1/', help_view, name='help_page'),
    ...
    path('manage_orders/', manage_orders_view, name='manage_orders'),
    ...
    path('setUpProfile/', set_up_profile_view, name='setUpProfile_page'),
    path('updateProfile/', update_profile_view, name='update_profile'),            # for text fields
    path('updateProfilePhoto/', update_profile_photo_view, name='update_profile_photo'),
